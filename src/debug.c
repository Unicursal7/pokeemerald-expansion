...
#define DEBUG_MENU_WIDTH_MAIN 8
#define DEBUG_MENU_HEIGHT_MAIN 3
...
{
    [DEBUG_PARTY_MENU_ITEM_HEAL_PARTY]      = {COMPOUND_STRING("PokeVial"),      DEBUG_PARTY_MENU_ITEM_HEAL_PARTY},
