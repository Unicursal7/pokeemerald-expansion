...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("CARLO");
const u8 gText_ExpandedPlaceholder_May[] = _("CARLO");
...
const u8 gText_ThisIsAPokemon[] = _("Nachher siehst du noch aus wie er!{PAUSE 96}\p");
...
const u8 gText_PlayerScurriedToCenter[] = _("Nachdem {PLAYER} Preisgeld abdrücken musste,\nist ihm aufgefallen, dass\nsein Kontostand schon wieder im Minus ist.\nDeshalb machte er sich auf zum nächsten Arbeitsamt.\p");
const u8 gText_PlayerScurriedBackHome[] = _("Also ehrlich, ich hab kein Bock,\nden Text hier anzupassen,\nweil ich mir sicher bin,\n dass du nicht so scheiße bist\nund schon vor dem ersten Arbeitsamt faintest.\p");
